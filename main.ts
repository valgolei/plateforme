...
function niveau_suivant () {
    ...
    if (progression == 15) {
        ...
        pause(100)
        game.showLongText("tu peux aussi rencontrer des trampolines, ils te permettront de sauter plus haut", DialogLayout.Bottom)
        game.showLongText("mais attentions au pics qui te blessent", DialogLayout.Bottom)
    }
    if (progression == 16) {
